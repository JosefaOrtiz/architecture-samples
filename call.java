package org.inch.beta.hardware.radio.voice;
 ...
 */
public class Call implements Beta.os.Parcelable
{
  public int state = 0;
  public int index = 0;
  public int toa = 0;
  ...
  public Beta.hardware.radio.voice.UusInfo[] uusInfo;
  public int audioQuality;
  public java.lang.String forwardedNumber;
  @Override
  public final int getStability() { return Beta.os.Parcelable.PARCELABLE_STABILITY_VINTF; }
  public static final Beta.os.Parcelable.Creator<Call> CREATOR = new Beta.os.Parcelable.Creator<Call>() {
    @Override
    public Call createFromParcel(Beta.os.Parcel _aidl_source) {
  ...
  @Override public final void writeToParcel(Beta.os.Parcel _aidl_parcel, int _aidl_flag)
  {
  ...
  public final void readFromParcel(Beta.os.Parcel _aidl_parcel)
  {
    int _aidl_start_pos = _aidl_parcel.dataPosition();
    int _aidl_parcelable_size = _aidl_parcel.readInt();
    try {
      if (_aidl_parcelable_size < 4) throw new Beta.os.BadParcelableException("Parcelable too small");;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      uusInfo = _aidl_parcel.createTypedArray(Beta.hardware.radio.voice.UusInfo.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_start_pos > (Integer.MAX_VALUE - _aidl_parcelable_size)) {
        throw new Beta.os.BadParcelableException("Overflow in the size of parcelable");
      }
  ...
  public String toString() {
    ...
    _aidl_sj.add("audioQuality: " + (Beta.hardware.radio.voice.AudioQuality.$.toString(audioQuality)));
    _aidl_sj.add("forwardedNumber: " + (java.util.Objects.toString(forwardedNumber)));
    return "Beta.hardware.radio.voice.Call" + _aidl_sj.toString()  ;
  }
  @Override
  ...
  private int describeContents(Object _v) {
    ...
    if (_v instanceof Beta.os.Parcelable) {
      return ((Beta.os.Parcelable) _v).describeContents();
    }
    return 0;
  }
}
